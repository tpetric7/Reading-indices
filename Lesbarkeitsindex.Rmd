...
```{r}
stringsAsFactor = F
prozess <- read_lines("data/novels/book05.txt")
enfants <- read_lines("data/novels/book12.txt")

romane <- readtext("data/novels/*.txt")
coronavirus2020 <- readtext("data/news/*.json", 
